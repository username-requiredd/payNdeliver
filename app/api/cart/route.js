...
export async function PUT(req) {
  console.log("Cart API route handler called for PUT");
  ...
  try {
    ...
    if (!data || !data.userId || !data.products) {
      console.log("Invalid data received");
      return NextResponse.json(
        { message: "Invalid cart data. Please provide userId and products." },
        { status: 400 }
      );
    }
    ...
    if (cart) {
      ...
      console.log("No existing cart found. Cannot update.");
      return NextResponse.json(
