...
const Sidebar = () => {
  ...
  const navItems = [
    { href: "/dashboards/admin", icon: LayoutDashboard, label: "Dashboard" },
    {
      href: "/dashboards/admin/managebusiness",
      icon: ShoppingBag,
      label: "Manage Business",
    },
    {
      href: "/dashboards/admin/manageusers",
      icon: Users,
      label: "Manage Users",
    },

    {
      href: "/dashboards/admin/managetransactions",
      icon: ArrowRightLeft,
      label: "Orders",
    },
    { href: "/dashboards/admin/managesales", icon: Coins, label: "Sales" },
  ];
  const toggleNav = () => {
    setIsOpen(!isOpen);
  };
